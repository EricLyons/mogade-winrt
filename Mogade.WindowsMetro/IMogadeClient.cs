...
namespace Mogade.WindowsMetro
{
    public interface IMogadeClient
    {
        ...
        /// this information...we just take it in, store it, and pass it back out
        /// </remarks>
        Task<Response<SavedScore>> SaveScoreAsync(string leaderboardId, Score score);
        ...
        /// <param name="page">The page to get (starting with 1)</param>
        /// <returns>A leaderboard object containing an array of scores</returns>
        Task<Response<LeaderboardScores>> GetLeaderboardAsync(string leaderboardId, LeaderboardScope scope, int page);
        ...
        /// <param name="records">The number of records (up to 50)</param>
        /// <returns>A leaderboard object containing an array of scores</returns>
        Task<Response<LeaderboardScoresWithPlayerStats>> GetLeaderboardWithPlayerStatsAsync(string leaderboardId, LeaderboardScope scope, string userName, int page, int records);
        ...
        /// <param name="userName">the name of the user</param>
        /// <returns>A leaderboard object containing an array of scores</returns>
        Task<Response<Score>> GetPlayerScoreAsync(string leaderboardId, LeaderboardScope scope, string userName);
        ...
        /// Will return up to 10 records. The user's score object will only be returned when page = 1 and, of course, if the user has a score
        /// </remarks>
        Task<Response<LeaderboardScores>> GetLeaderboardAsync(string leaderboardId, LeaderboardScope scope, string userName, int records);
        ...
        /// <param name="userName">the name of the user</param>
        /// <returns>The scores of the closest 3 players (could be length 2, 1 or 0)</returns>
        Task<Response<IList<Score>>> GetRivalsAsync(string leaderboardId, LeaderboardScope scope, string userName);
        ...
        /// <param name="userName">the name of the user</param>
        /// <returns>Returns a rank object (0 means the user doesn't have a rank for the specified scope)</returns>
        Task<Response<Ranks>> GetRanksAsync(string leaderboardId, string userName);
        ...
        /// <param name="scope">The scope to get the rank for</param>
        /// <returns>Returns the user's rank (0 means the user doesn't have a rank for the specified scope)</returns>
        Task<Response<int>> GetRankAsync(string leaderboardId, string userName, LeaderboardScope scope);
        ...
        /// <param name="scopes">The scopes to get the rank for</param>
        /// <returns>Returns the user's rank (0 means the user doesn't have a rank for the specified scope, or that the scope wasn't requested)</returns>
        Task<Response<Ranks>> GetRanksAsync(string leaderboardId, string userName, LeaderboardScope[] scopes);
        ...
        /// <param name="userName">the name of the user</param>
        /// <returns>An array containing the achievements earned by the user (or an empty array if the user hasn't earned anything)</returns>
        Task<Response<ICollection<string>>> GetEarnedAchievementsAsync(string userName);
        ...
        /// <param name="userName">the name of the user</param>
        /// <returns>An array containing the achievements earned by the user (or an achievement with a null id if the user has already earned it)</returns>
        Task<Response<Achievement>> AchievementEarnedAsync(string achievementId, string userName);


        /// <summary>
        /// Logs an application start (for analytic purposes)
        /// </summary>
        Task<Response> LogApplicationStartAsync();
        ...
        /// renames a user
        /// </summary>
        Task<Response<bool>> RenameAsync(string currentUserName, string newUserName);
